  ...
  return (
    <>
      <div className="bg-[#DAD3BE] scroll-smooth focus:scroll-auto min-h-screen max-h-screen flex justify-center items-center relative">
        <div className="absolute z-10 top-0 left-0 right-0 bottom-0 flex justify-center pt-20">
          <div className="flex flex-col gap-2 text-center">
            <p className="text-3xl font-sans font-bold">
              Terima Kasih Sudah Bertransaksi
            </p>
            <p className="text-3xl font-sans font-semiboldbold">
              Barang Anda akan segera kami proses
            </p>
          </div>
        </div>
        <div class="loader">
          <div class="truckWrapper scale-[2] md:scale-[3]">
            <div class="truckBody">
              <svg
